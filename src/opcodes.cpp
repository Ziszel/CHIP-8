...
void decodeOpcode(Cpu &cpu, std::array<BYTE, 16> &keys)
{
    ...
    case 0x2000:
        ...
        break;
    case 0x3000:
        opcode3XNN(opcode, cpu, regX);
        break;
    case 0x4000:
        opcode4XNN(opcode, cpu, regX);
        break;
    case 0x5000:
        opcode5XY0(opcode, cpu, regX, regY);
        break;
    case 0x6000:
        opcode6XNN(opcode, cpu, regX);
        break;
    case 0x7000:
        opcode7XNN(opcode, cpu, regX);
        break;
    case 0x8000:
    {
        switch (opcode & 0xF)
        {
        case 0x0:
            opcode8XY0(opcode, cpu, regX, regY);
            break;
        case 0x1:
            opcode8XY1(opcode, cpu, regX, regY);
            break;
        case 0x2:
            opcode8XY2(opcode, cpu, regX, regY);
            break;
        case 0x3:
            opcode8XY3(opcode, cpu, regX, regY);
            break;
        case 0x4:
            opcode8XY4(opcode, cpu, regX, regY);
            break;
        case 0x5:
            opcode8XY5(opcode, cpu, regX, regY);
            break;
        case 0x6:
            opcode8XY6(opcode, cpu, regX);
            break;
        case 0x7:
            opcode8XY7(opcode, cpu, regX, regY);
            break;
        case 0xE:
            opcode8XYE(opcode, cpu, regX);
            break;
        }
        break;
    }
    case 0x9000:
        opcode9XY0(opcode, cpu, regX, regY);
        break;
    case 0xA000:
    ...
    case 0xB000:
        ...
        break;
    case 0xC000:
        opcodeCXNN(opcode, cpu, regX);
        break;
    case 0xD000:
        opcodeDXYN(opcode, cpu, regX, regY);
        break;
    case 0xE000:
    {
        switch (opcode & 0xF)
        {
        case 0xE:
            opcodeEX9E(opcode, cpu, keys, regX);
            break;
        case 0x1:
            opcodeEXA1(opcode, cpu, keys, regX);
            break;
        }
        break;
    }
    case 0xF000:
    {
        ...
        {
        case 0x07:
            opcodeFX07(opcode, cpu, regX);
            break;
        case 0x0A:
            opcodeFX0A(opcode, cpu, keys, regX);
            break;
        case 0x15:
            opcodeFX15(opcode, cpu, regX);
            break;
        case 0x18:
            opcodeFX18(opcode, cpu, regX);
            break;
        case 0x1E:
            opcodeFX1E(opcode, cpu, regX);
            break;
        case 0x29:
            opcodeFX29(opcode, cpu, regX);
            break;
        case 0x33:
            opcodeFX33(opcode, cpu, regX);
            break;
        case 0x55:
            opcodeFX55(opcode, cpu, regX);
            break;
        case 0x65:
            opcodeFX65(opcode, cpu, regX);
            break;
        }
        break;
    }
